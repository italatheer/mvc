...
/*********************************************************************************************/
	...
	if($_POST['procedure_title_action'] ==='accept'){
		...
		$data_ezn['current_to_name'] 		 = $this->get_manager_name(array('id'=>$this->input->post('to_id')))->employee;
		...
		$data_transformation['to_name'] 		 = $this->get_manager_name(array('id'=>$this->input->post('to_id')))->employee;
