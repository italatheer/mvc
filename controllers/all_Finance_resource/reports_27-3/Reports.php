...
class Reports extends MY_Controller
{
    ...
    public function get_report_member()
    {
        ...
        if ($type_member == 0 && $fe2a == 0) {
            ...
            $data_all['all_aytam'] = $this->Reports_Model->get_member_fr_khfalat();
...
return;*/
        ...
        if ($this->input->post('searchOf')==0 ) {
            $data['current_year'] = $this->current_hjri_year();
            $data['valu'] = 0;
            $data['records'] = $this->Report_family_model->get_all_fr();
            $this->load->view('admin/all_Finance_resource_views/reports/load_mother_m_page', $data);


        } else if ($type_member == 0 && $fe2a == 0) {
