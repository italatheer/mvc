...
public function getConnection()
{
    ...
    $all_Donors = $this->Main_model->get_updates('arch_wared',array('suspend'=>4));
...
///
public function getConnection_sader()
{
    
    $all_Donors_sader = $this->Main_model->get_updates('arch_sader',array('suspend'=>4));
    //$this->test( $all_Donors);
