...
//    15-4-om
    function upload_muli_file($input_name, $folder = false)
    {
        ...
        for ($i = 0; $i < $filesCount; $i++) {
            ...
            $all_file[] = $this->upload_file("file", $folder);
        }
        return $all_file;
    }
    ...
    {// md/all_gam3ia_omomia_members/Gam3ia_omomia_members/add_gam3ia_member
        ...
        if ($this->input->post('save')) {
            ...
            $file['mem_img'] = $this->upload_file($member_img, 'uploads/md/gam3ia_omomia_members');
            $file['card_img'] = $this->upload_file($card_img, 'uploads/md/gam3ia_omomia_members');
