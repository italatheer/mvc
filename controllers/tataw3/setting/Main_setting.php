...
class Main_setting extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('tataw3/setting/Main_setting_m');
...
//        /*************************************************************/
    ...
    public function index($type=0)//tataw3/setting/Main_setting/
    {
        $data['typee']= $type;
        ...
        $data['title'] = 'اعدادات';
        $data['subview'] = 'admin/tataw3_v/setting/Main_setting_view';
    ...
    public function AddSetting($from_code){  // tataw3/setting/Main_setting/AddSetting
        ...
        if($this->input->post('add')){
            ...
            redirect('tataw3/setting/Main_setting/index/'.$from_code,'refresh');
