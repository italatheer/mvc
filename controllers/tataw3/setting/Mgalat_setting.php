...
class Mgalat_setting extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('tataw3/setting/Mgalat_setting_m');
//        /**********************************************************/
...
//        /*************************************************************/
    ...
    public function index()//tataw3/setting/Mgalat_setting
    {
        ...
        if ($this->input->post('id') ==0) {
            ...
            $data['subview'] = 'admin/tataw3_v/setting/Mgalat_setting_view';
    ...
    function get_data_table($type)
    {
        ...
        $this->load->view('admin/tataw3_v/setting/Mgalat_setting_table_view', $data);
    }
