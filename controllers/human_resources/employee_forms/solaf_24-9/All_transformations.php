...
return $HYear;
    ...
    /************************************************************/
    public function index(){//human_resources/employee_forms/solaf/All_transformations
     // $this->test($_SESSION);
...
//$this->test($data['coming_records']);
   ...
   /* public function Get_load_page(){
        ...
        $data_load["agaza_data"]=$this->Hr_solaf_transformation_setting_model->get_agaza_data(array('agaza_rkm'=>$this->input->post('agaza_rkm')));
        $data_load["agaza_level"] = $data_load["agaza_data"]->level;
      //  direct_manager_id_fk
       $data_load["modeer_mobasher"]=$this->Hr_solaf_transformation_setting_model->get_user_data2(array('employees.id'=>$data_load["agaza_data"]->direct_manager_id_fk));
       // $this->test($data_load["agaza_data"]->direct_manager_id_fk);


    $data_load['department_jobs_all'] =$this->Hr_solaf_transformation_setting_model->select_department_jobs();
    // $this->test( $data['department_jobs_all'] );
       // get_user_data2
        //direct_manager_id_fk

        $data_load["level_2data"]=$this->Hr_solaf_transformation_setting_model->select_hr_all_transformations_history_by_level(array('agaza_rkm_fk'=>$this->input->post('agaza_rkm'),'level'=>2));
        $data_load["level_3data"]=$this->Hr_solaf_transformation_setting_model->select_hr_all_transformations_history_by_level(array('agaza_rkm_fk'=>$this->input->post('agaza_rkm'),'level'=>3));
        $data_load["level_4data"]=$this->Hr_solaf_transformation_setting_model->select_hr_all_transformations_history_by_level(array('agaza_rkm_fk'=>$this->input->post('agaza_rkm'),'level'=>4));
