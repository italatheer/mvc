    ...
    <div class="container-fluid">
     ...
     <!--   <ul id="myListprojects" class="list-unstyled"> -->
               ...
               <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="card">
                    <a href="<?php echo base_url().'Web/single_prograam/'.$row->id?>">
                        ...
                        <div class="card-content">
                            <div class="card-content-member text-center">
                                <h4 class="m-t-0"><a style="color: red !important;" href="<?php echo base_url().'Web/single_prograam/'.$row->id?>" class="ft-20"><?= $row->project_name?></a></h4>
                            </div>
