...
<div class="container-fluid no-padding revolution-slider">
            ...
            <div class="rev_slider" data-version="5.0">
                <ul>
                    ...
                    <li class="hidden" data-index="rs-6" data-transition="slidingoverlayhorizontal"
                        ...
                        data-thumb="img/slider/slide-4.jpg" data-rotate="0" data-saveperformance="off"
                        data-title="عنوان الصورة الثالثة 3" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?= base_url() . 'asisst/web_asset/' ?>img/slider/slide-4.jpg" alt=""
                             data-bgposition="center center" data-bgfit="100% 100%" data-bgrepeat="no-repeat"
                             class="rev-slidebg" data-bgparallax="10" data-no-retina>
                    </li>
...
<section class="bottom_slider">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 no-padding">
        <div class="Know_charity">
            <h2 class="pbottom-10 ptop-10"><?= $nabza[0]->title?></h2>
            <h4 class="pbottom-10">  <?= $nabza[0]->sub_title?> </h4>
        ...
        <div class="col-md-7">
            <div class="padding-4 width_lg_md_20">
                <div class="counter_box text-center div_bgr1">
                    ...
                    <div class="counter" data-count="<?php if((isset($count['mother_count']))&&(!empty($count['mother_count']))){ echo $count['mother_count'];}?>">0</div>
                    <h5>
                        أرملة</h5>
                    <div class="under_counter ">
                        <h5>
                            <div class=" counter" data-count="<?php if((isset($count['mother_makfol_count']))&&(!empty($count['mother_makfol_count']))){ echo $count['mother_makfol_count'];}?>">0</div>
                            مكفول
                        </h5>
                        <h5>
                            <div class=" counter" data-count="<?php if((isset($count['mother_count']))&&(!empty($count['mother_count']))){ echo $count['mother_count']-$count['mother_makfol_count'];}?>">0</div>
                            غير مكفول
                        </h5>
                    </div>
                </div>
            ...
            <div class=" padding-4 width_lg_md_20 ">
                <div class="counter_box text-center div_bgr2">
                    ...
                    <div class=" counter" data-count="<?php if((isset($count['yatem_count']))&&(!empty($count['yatem_count']))){ echo $count['yatem_count'];}?>">0</div>
                    <h5>يتيم</h5>
                    <div class="under_counter ">
                        <h5>
                            <div class=" counter" data-count="<?php if((isset($count['yatem_makfol_count']))&&(!empty($count['yatem_makfol_count']))){ echo $count['yatem_makfol_count'];}?>">0</div>
                            مكفول
                        </h5>
                        <h5>
                            <div class=" counter" data-count="<?php if((isset($count['yatem_count']))&&(!empty($count['yatem_count']))){ echo $count['yatem_count']-$count['yatem_makfol_count'];}?>">0</div>
                            غير مكفول
                        </h5>
                    </div>
                </div>
            ...
            <div class="padding-4 width_lg_md_20 ">
                <div class="counter_box text-center div_bgr1">
                    ...
                    <div class=" counter" data-count="<?php if((isset($count['mostafed_count']))&&(!empty($count['mostafed_count']))){ echo $count['mostafed_count'];}?>">0</div>
                    <h5>مستفيد</h5>
                    <div class="under_counter ">
                        <h5>
                            <div class=" counter" data-count="<?php if((isset($count['mosdafed_makfol_count']))&&(!empty($count['mosdafed_makfol_count']))){ echo $count['mosdafed_makfol_count'];}?>">0</div>
                            مكفول
                        </h5>
                        <h5>
                            <div class=" counter" data-count="<?php if((isset($count['mostafed_count']))&&(!empty($count['mostafed_count']))){ echo $count['mostafed_count']-$count['mosdafed_makfol_count'];}?>">0</div>
                            غير مكفول
                        </h5>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="card">
                        <div class="card-header"
                             style="background-image: url(<?= base_url()."uploads/images/".$row->img?>);">
                        </div>
                        <div class="card-content">
                            <div class="card-content-member text-center">
                                <h4 class="m-t-0"><a href="single_project.html" class="ft-20"><?= $row->project_name?></a>
                                </h4>
                            </div>
