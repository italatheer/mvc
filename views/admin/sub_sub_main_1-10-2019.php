                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="circle_counter" style="background: green;">
                            ...
                            <div class=" counter" data-count="<?php echo $all_data_count['aytam']['num']; ?>">0</div></a>
                            <div style="width:50%;float: right;text-align: center">
                                <h5> مكفول</h5>
                                <a onclick="LoadSubTable('aytam','guaranteed')" data-toggle="modal" data-target="#detailsModal2">
                                    <div class=" counter" data-count="<?php echo $all_data_count['aytam']['guaranteed']; ?>">0 </div></a>
                            </div>
                            <div style="width:50%;float: right;text-align: center">
                                <h5>غير مكفول</h5>
                                <a onclick="LoadSubTable('aytam','not_guaranteed')" data-toggle="modal" data-target="#detailsModal2">
                                    <div class=" counter" data-count="<?php echo $all_data_count['aytam']['not_guaranteed']; ?>">0 </div></a>
                            </div>
                        ...
                        <div id="circle_counter"  style="background: #b77b09;">
                            ...
                            <a onclick="LoadTable('armal')" data-toggle="modal" data-target="#detailsModal">
                                <div class=" counter" data-count="<?php echo $all_data_count['armal']['num']; ?>">0 </div></a>
                            <div style="width:50%;float: right;text-align: center">
                                <h5> مكفول</h5>
                                <a onclick="LoadSubTable('armal','guaranteed')" data-toggle="modal" data-target="#detailsModal2">

                                    <div class=" counter" data-count="<?php echo $all_data_count['armal']['guaranteed']; ?>">0 </div></a>
                            </div>
                            <div style="width:50%;float: right;text-align: center">
                                <h5>غير مكفول</h5>
                                <a onclick="LoadSubTable('armal','not_guaranteed')" data-toggle="modal" data-target="#detailsModal2">

                                    <div class=" counter" data-count="<?php echo $all_data_count['armal']['not_guaranteed']; ?>">0 </div></a>
                            </div>
                        ...
                        <div id="circle_counter" style="background: #6d2147;">
                            ...
                            <a onclick="LoadTable('mostafed')" data-toggle="modal" data-target="#detailsModal">
                                <div class=" counter" data-count="<?php echo $all_data_count['mostafed']['num']; ?>">0</div></a>
                            <div style="width:50%;float: right;text-align: center">
                                <h5> مكفول</h5>
                                <a onclick="LoadSubTable('mostafed','guaranteed')" data-toggle="modal" data-target="#detailsModal2">
                                    <div class=" counter" data-count="<?php echo $all_data_count['mostafed']['guaranteed']; ?>">0 </div></a>
                            </div>
                            <div style="width:50%;float: right;text-align: center">
                                <h5>غير مكفول</h5>
                                <a onclick="LoadSubTable('mostafed','not_guaranteed')" data-toggle="modal" data-target="#detailsModal2">
                                    <div class=" counter" data-count="<?php echo $all_data_count['mostafed']['not_guaranteed']; ?>">0 </div></a>
                            </div>
...
<script>
    ...
    function LoadTable(value) {
        ...
        if (type!='') {
            ...
            $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>Dash/GetAllPage',
                data:dataString,
                dataType: 'html',
                cache:false,
                beforeSend: function() {
    ...
    function LoadSubTable(value,personType) {
        ...
        if (type !='' && personType !='') {
            ...
            $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>Dash/GetSubPage',
                data:dataString,
                dataType: 'html',
                cache:false,
                beforeSend: function() {
