        ...
        <div class="panel-body">
            ...
            <div class="col-xs-12 no-padding">
                ...
                <div class="form-group col-md-2 col-sm-2 col-xs-12 padding-4">
                    ...
                    <input type="datetime-local" name="tasgel_date"
                           value="<?=date('Y-m-d\TH:i:s');?>"
                           class="form-control  " readonly  >

                </div>
                <!--<div class="form-group col-md-2 col-sm-2 col-xs-12 padding-4">
                    <label class="label"> تاريخ الصادر  </label>
                ...
                <div class="form-group col-md-2 col-sm-2 col-xs-12 padding-4">
                    ...
                    <input type="datetime-local" name="ersal_date"
                           value="<?= $ersal_date?>"
                           class="form-control  "   >
...
<!--                 
                ...
                <div class="form-group col-md-2 col-sm-2 col-xs-12 padding-4">
                    ...
                    <input type="datetime-local" name="esthkak_date"
                           value="<?= $esthkak_date ?>"
                           class="form-control  "   >
