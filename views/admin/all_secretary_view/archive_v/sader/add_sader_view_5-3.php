...
<div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
   ...
   $emp_depart = $emp_dep->emp_edara_code;
$emp_depart_name = $emp_dep->emp_edara_name; 
    ...
    $emp_depart_name = 0;  
            ...
            <input type="hidden" name="emp_depart_code" value="<?= $emp_depart?>" />
                <div class="form-group col-md-2 col-sm-3 col-xs-12 padding-4">
                    ...
                    <input title="<?= $emp_depart_name ?>" type="text" name=""
                    ...
                    foreach ($all_sader as $row){
                        ...
                        <tr>
                            ...
                            <span class="label" style="background-color: #32e26b"> 
                             <?=$row->year.'/'. $row->emp_depart_code .'/'.$row->sader_rkm?>
                             </span>
                           </td>
