...
<div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
   ...
   $color='';
    ...
    <select  type="text" name="sader_type" id="sader_type"
                     ...
                     foreach ($gehat as $row){
                         ...
                         <tr>
                             ...
                             <!--<td><input style="width: 90px;height: 20px;" type="radio" name="radio"
                                        id="gehat<?= $row->id ?>"
                                        ondblclick="GetgehaName(<?= $row->id ?>,'<?= $row->name?>')"></td>-->
                             <td><?=$z++;?></td>
                             <td  style="cursor: pointer" id="gehat<?= $row->id ?>"
                                  onclick="GetgehaName(<?= $row->id ?>,'<?= $row->name?>')">
                                     <?= $row->name  ?>
                             </td>
                    ...
                    <table class="table example table-bordered table-striped table-hover">
                        ...
                        foreach ($folders as $row){
                            ...
                            <tr>
                                ...
                                <td><?php echo $z++;?></td>
                                <td style="cursor: pointer" data-title="<?= $row->id ?>"  onclick="GetfolderName(<?= $row->id?>,'<?= $row->ar_title?>','<?= $row->path?>')">
                                    <?= $row->ar_title ?>
                                </td>
