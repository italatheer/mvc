                ...
                ?>
                    ...
                    <div class="col-xs-2 form-group padding-4">
                        ...
                        <div class="col-xs-2 form-group padding-4">
                            ...
                            <input type="date" class="form-control dateComponent " name="from_date" value="<?= date('Y-m-d')?>"
                                   id="from_date"
                        ...
                        <div class="col-xs-2 form-group padding-4">
                            ...
                            <input type="date" class="form-control dateComponent " name="to_date" value="<?= date('Y-m-d')?>"
                                   id="to_date"
                                   oninput="get_job_date()"
                            >
