        ...
        <div class="col-sm-3 no-padding">
            ...
            <div class="col-md-12 no-padding">
                <div class="user-widget list-group">
                    ...
                    <a href="#" class="list-group-item">
                        ...
                        <?php if(isset($personal_data)){  echo $personal_data[0]->employee;}?>
                        
                        </p>

                    </a>
                    <a href="#" class="list-group-item">
                        <p class="list-group-item-text"><strong class="text-danger ">الإدارة :&nbsp &nbsp</strong> <?php if(isset($personal_data)){ echo  $personal_data[0]->admin_name;}?></p>
                    </a>
                    <a href="#" class="list-group-item">
                        <p class="list-group-item-text"><strong class="text-danger ">القسم  :&nbsp &nbsp</strong> <?php if(isset($personal_data)){ echo $personal_data[0]->depart_name;}?></p>
                    </a>
                    <a href="#" class="list-group-item">
                        <p class="list-group-item-text"><strong class="text-danger ">المسمى الوظيفى   :&nbsp &nbsp</strong> <?php if(isset($personal_data)){ echo  $personal_data[0]->degree_name;}?></p>
                    </a>
                    <a href="#" class="list-group-item">
                        <p class="list-group-item-text"><strong class="text-danger ">المدير المباشر   :&nbsp &nbsp</strong> <?php if(isset($personal_data)){ echo  $personal_data[0]->manger_name;}?></p>
                    </a>
                    -->
                </div>
            </div>
            <div class="col-md-12 no-padding">
                <div class="user-widget list-group">
                    ...
                    <a href="#" class="list-group-item">
                        <p class="pull-right"><?php if(isset($personal_data)){  echo $personal_data[0]->sum_all_esthqaq;}?>  </p>
                        <p class="list-group-item-text text-primary"><strong>الأستحقاقات المالية: </strong></p>
                    </a>
                    <a href="#" class="list-group-item">
                        <p class="pull-right"> <?php if(isset($personal_data)){  echo  $personal_data[0]->sum_all_estqta3;}?></p>
                        <p class="list-group-item-text text-primary"><strong>الأستقطاعات:</strong></p>
                    </a>
                    
                      <a href="#" class="list-group-item">
                        <p class="pull-right"> <?php if(isset($personal_data)){ 
