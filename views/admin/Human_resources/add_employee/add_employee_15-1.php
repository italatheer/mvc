                ...
                <div class="col-md-12 no-padding">
                    ...
                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                        ...
                        if (isset($records) && !empty($records)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="label  label-<?= $class ?> "
                                              style="font-size: 14px;"><?= $emp_type[$record->employee_type] ?></span>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                        ...
                                        <a href="<?php echo base_url(); ?>human_resources/human_resources/edit_emp/<?php echo $record->emp_code; ?>"><i
                                        ...
                                        <!-- <<a href="<?php echo base_url('human_resources/Human_resources/print_employee_details') . '/' . $record->id ?>"
                                           target="_blank">
                                            <i class="fa fa-print" aria-hidden="true"></i> </a>  -->
                                            <a onclick="print_employee_details(<?= $record->id ?>)" title="طباعه"><i
                                            class="fa fa-print"></i></a>

                                        <!-- <a href="<?php echo base_url('human_resources/Human_resources/print_card') . '/' . $record->id ?>"
                                           target="_blank">
                            ...
                            <td colspan="6">
                                <div style="color: red; font-size: large;">لم يتم اضافه موظفين الي الان</div>
                            </td>
                        <?php }
                        ?>
                        </tbody>
