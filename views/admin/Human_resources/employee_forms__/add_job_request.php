            ...
            <div class="panel-body">
                ...
                <div class="col-md-12 ">
                    <div class="form-group col-md-3  col-sm-6 padding-4">
                        ...
                        if(!empty($emp_data)){   echo$emp_data->administration_name; echo'-';echo $emp_data->departments_name;}else{ echo 'غيرمحدد';} } ?>"
                                readonly class="form-control bottom-input"
                               data-validation-has-keyup-event="true">
                        <input type="hidden" name="dep_id_fk" value="<?php echo$emp_data->administration; echo'-'; echo $emp_data->department; ?>">
                    </div>
                    <div class="form-group col-md-3 col-sm-6 padding-4">
