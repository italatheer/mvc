<tr>
    ...
    <td> <input type="text" name="date_from[]" data-validation="required"  id=""  data-validation="required" value=""
                class="form-control bottom-input date_as_mask"
                data-validation-has-keyup-event="true">
        الي <input type="text" data-validation="required" name="date_to[]"  id=""  data-validation="required" value=""
                       class="form-control bottom-input date_as_mask"
                       data-validation-has-keyup-event="true">
        </td>
