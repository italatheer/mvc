...
<div class="col-sm-12  wow" >
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12">
                <th  colspan="6"><button class="btn btn-add" type="button" onclick="add_row(5,'recognize')">اضافه  المعرفون</button>
                </th>
                ...
                <input type="submit" style="display: none" name="add" value="حفظ"  id="register" class="button-add  recognize">
