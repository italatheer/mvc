                    ...
                    foreach ($allData->badlat as $record) {
                        ...
                        if (in_array($record->badalat->badl_discount_id_fk, $bdalat_id)) {
                            ...
                            <tr>
                                ...
                                <!-- Nagwa 20-6  -->
                                <td>
                                    <input name="dalel_code" id="dalel_code" class="form-control"
                    ...
                    <div class="modal-body row">
                        <div class="col-sm-8 no-padding">
                            ...
                            <div class="form-group col-xs-12">
                                <label class="label label-green  half">اسم البنك<strong
                                            class="astric">*</strong><strong></strong> </label>
                                <select name="edit_bank_id_fk" id="bank_id_fk<?php echo $value->id; ?>"
                                        data-validation="required" aria-required="true"
                                        onchange="get_code_bank(<?php echo $value->id; ?>)" class="form-control half">
                            ...
                            <div class="form-group col-xs-12">
                                <label class="label label-green  half">كود البنك<strong
                                            class="astric">*</strong><strong></strong> </label>
                                <input type="text" class="form-control half input-style" name=""
                        ...
                        <div class="col-sm-4 no-padding">
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <input type="file" id="bank_image" name="bank_image" class="form-control"
                                       onchange="readURL(this,<?php echo $value->id; ?>);">
                        ...
                        <div class="modal-body row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control half" id=""
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control half value<?php echo $record->badalat->badl_discount_id_fk ?>"
