...
if($this->uri->segment(5) == ""){
    $disabled_f2a = '';
    $action='حفظ';
	echo form_open_multipart('human_resources/tataw3/Tataw3_c/new_motato3'); 
}
else{
...
<script type="text/javascript">
	...
	function checkUnique(argument) {
        ...
        $.ajax({
            type:'post',
            url: '<?php echo base_url() ?>human_resources/tataw3/Tataw3_c/checkUnique',
...
$( document ).ready(function() {
    ...
    function load_tahwel() {
      ...
      //  alert(type);
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url()?>human_resources/tataw3/Tataw3_c/load_tahwel' ,
            data: {type:type},
            dataType: 'html',
            cache: false,
