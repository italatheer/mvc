...
<?php } ?>
    <!-- Nagwa 20-6 -->
    <td>
        <input name="dalel_code[]" id="dalel_code<?=$type?><?php echo $len;?>" class="form-control"
               value="" readonly>

        <!--<select name="dalel_code[]" class="form-control" id="hesab_name<?=$type?><?php echo $len;?>" data-validation="required">
