...
<div class="col-sm-12 col-md-12 col-xs-12 fadeInUp wow">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
          ...
          <!--  <div class="col-sm-12">
                <h6 class="text-center inner-heading">بيانات  الإستحقاقات </h6>
            </div>
-->
    ...
    <select name="markz" id="markz"
        ...
        ?>
                ...
                <table class="display table table-bordered responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-12">
                                    <input type="date" class="form-control bottom-input date<?=$record->id?> <?=$class?>" name="date_from[<?=$record->id?>]" <?php if(isset($allData) && isset($allData->badlat[$record->id]) && $allData->badlat[$record->id]->date_from > 0) echo 'data-validation="required" value="'.date("Y-m-d",$allData->badlat[$record->id]->date_from).'"'; else echo 'disabled' ?> <?=$disabled?> />
                                </div>
                            </td>
                            <td>
                                <div class="col-sm-12">
                                    <input type="date" class="form-control bottom-input date<?=$record->id?> <?=$class?>" name="date_to[<?=$record->id?>]" <?php if(isset($allData) && isset($allData->badlat[$record->id]) && $allData->badlat[$record->id]->date_to > 0) echo 'data-validation="required" value="'.date("Y-m-d",$allData->badlat[$record->id]->date_to).'"'; else echo 'disabled' ?> <?=$disabled?> />
                                </div>
                            </td>
                            <td>
            ...
            <div class="form-group col-sm-4 col-xs-12">
                ...
                <input type="number" min="1" class="form-control bottom-input" name="number" id="number" <?php if(isset($allData) && $allData->Banks == null) echo 'data-validation="required"' ?> onkeyup="getBanks($(this).val(),<?php if(isset($allData->Banks)) echo count($allData->Banks); else echo 0; ?>);" />
            </div>
