            ...
            <table class="display table table-bordered responsive nowrap" cellspacing="0" width="100%">
                ...
                <tr>
                    <td>
                        ...
                        -->
                        <select name="title[<?=$in?>]" id="title<?=$in?>" class="form-control"  <?=$disabled?>  >
                    ...
                    <td>
                        ...
                        <?php 
                         ...
                         if(isset($allData)){
                            ?>
                             <div class="col-sm-12">
							<a href="<?php echo base_url() . 'human_resources/Human_resources/downloads/'.$value->emp_file ?>" download> <i class="fa fa-download" title="تحميل"></i> </a>
							<a target="_blank" href="<?php echo base_url() . 'human_resources/Human_resources/read_file/'.$value->emp_file ?>" > <i class="fa fa-eye" title=" قراءة"></i> </a>
                            </div>
                        <?php
                         }else{ ?>
                            <div class="col-sm-12">
