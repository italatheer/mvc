            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="Mgalat">
                    <div class=" col-md-12 col-sm-12  col-xs-12 Mgalat_form ">
                        <?php echo form_open(base_url() . 'human_resources/tataw3/setting/Mgalat_setting', array('id' => 'Mgalat_form')) ?>
    ...
    margin-left: 323px;">
                ...
                <div class="tab-pane fade " id="activety">
                    <div class=" col-md-12 col-sm-12  col-xs-12 active_form">
                        <?php echo form_open(base_url() . 'human_resources/tataw3/setting/Mgalat_setting', array('id' => 'active_form')) ?>
                        <div class="col-md-12 col-sm-12">
...
<script>
    ...
    function get_select_data() {
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo base_url() ?>human_resources/tataw3/setting/Mgalat_setting/get_select_data',
            data: {},
            cache: false,
    ...
    function get_data_table(type) {
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo base_url() ?>human_resources/tataw3/setting/Mgalat_setting/get_data_table/' + type,
            data: {},
            cache: false,
            beforeSend: function () {
...
<script>
    function delete_data_form(id, type) {
        $.ajax({
            type: 'get',
            url: '<?php echo base_url() ?>human_resources/tataw3/setting/Mgalat_setting/delete_data/' + id,
            data: {},
            cache: false,
            beforeSend: function () {
                swal({
    ...
    function set_data_form(id, type) {
        $.ajax({
            type: 'get',
            url: '<?php echo base_url() ?>human_resources/tataw3/setting/Mgalat_setting/set_data_form/' + id,
            data: {},
            cache: false,
            beforeSend: function () {
                swal({
