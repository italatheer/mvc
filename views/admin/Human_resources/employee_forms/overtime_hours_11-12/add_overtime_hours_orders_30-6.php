                                                    ...
                                                    <div class="piece-body">
                                                        <div class="col-xs-12 no-padding">
                                                            ...
                                                            <div class="col-xs-12 no-padding under-line open_green">
                                                                <div class="col-xs-4">
                                                                    <h6>اسم الموظف<span class="valu">/<?php echo $row->emp_name ;?></span></h6>
                                                                </div>
                                                                <div class="col-xs-4">
                                                                    <h6>الرقم الوظيفي<span class="valu">/<?php echo $row->emp_code_fk ;?></span></h6>
                                                                </div>
                                                                <div class="col-xs-4">
                                                                    <h6>المسمى الوظيفي<span class="valu">/<?php echo $row->mosama_wazefy ;?></span></h6>
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-12 no-padding under-line ">
                                                                <div class="col-xs-4">
                                                                    <h6>الإدارة<span class="valu">/<?php echo $row->edara_n ;?></span></h6>
                                                                </div>
                                                                <div class="col-xs-4">
                                                                    <h6>القسم<span class="valu">/<?php echo $row->qsm_n ;?></span></h6>
                                                                </div>
                                                                <div class="col-xs-4">
                                                                    <h6>التاريخ<span class="valu">/<?php echo $row->order_date ;?></span></h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="piece-box">
                                                    ...
                                                    <div class="piece-body" >
                                                        <div class="col-xs-12 under-line open_green">
                                                            <h5 class="text-center">الأستاذ / <?=$row->direct_manger_n?>   المحترم</h5>

                                                            <h5>  &nbsp &nbsp&nbsp&nbsp مسمى الوظيفة : <?=$row->direct_manger_mosama_wazefy?></h5>

                                                            <h6>  &nbsp &nbsp&nbsp&nbsp نظراً لـ <?=$row->nazran_to?> فقد تم تكليفكم بإنجاز العمل التالي :</h6><br>

                                                            <h6>&nbsp &nbsp&nbsp&nbsp  -	<?=$row->work_assigned_details?></h6>

                                                          <!--  <h6 class="text-center">&nbsp   على أن يتم ذلك خلال اليوم/الأيام والأوقات المحددة أدناه </h6><br>
                                                            <h6 class="text-center">وألا تتجاوز عدد الساعات (  <?=$row->total_hours?>   ) ساعة / ساعات .     وجزاكم الله خيراً ،،،</h6><br>
...
-->
                                                        ...
                                                        <?php $z=1; foreach ($row->details as $record){
                                                            ...
                                                            <?php $bdal_type_arr =array(0=>'بدل نقدي',1=>'بدل أيام الراحة');?>
                                                                ...
                                                                <tr class="">
                                                                    ...
                                                                    <td>   <?php if($record->bdal_type_fk ==1){ echo 'بدل أيام الراحة';}elseif($record->bdal_type_fk ==0){ echo'بدل نقدي';}?></td>
