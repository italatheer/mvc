...
<input type="text" name="qust_num" id="qust_num" onchange="Getdiv(this.value)"
...
<input type="text" id="quest_val"
   value="<?php if($sadad_solfa==3){echo $qemt_solaf/$qust_num; }?>"
   class="form-control "
   data-validation="required" onkeypress="validate_number(event);"
   data-validation-has-keyup-event="true">
            ...
            <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
                ...
                <table id="example" class=" display table table-bordered   responsive nowrap" cellspacing="0"
                    ...
                    <td><?php echo $row->qust_num; ?></td>
                                <td><?php if($row->qust_num>0){echo round( ($row->qemt_solaf/$row->qust_num)*100)/100; }?></td>
...
<script>
    function GetType(valu) {
        ...
        if (valu == 1) {
            ...
            document.getElementById("qust_num").value = 1;
            document.getElementById("qust_num").setAttribute("disabled", "disabled");
        ...
        document.getElementById("quest_val").value = document.getElementById("qemt_solaf").value;
            ...
            document.getElementById("qust_num").value = '';
          

            document.getElementById("qust_num").removeAttribute("disabled", "disabled");
...
<script>
    function Getdiv(valu) {
        console.log(valu);
            ...
            console.log(document.getElementById("qust_num").value);
            //document.getElementById("quest_val").removeAttribute("disabled", "disabled");
            document.getElementById("quest_val").value = Math.round((document.getElementById("qemt_solaf").value/document.getElementById("qust_num").value)*100)/100;
            document.getElementById("quest_val").setAttribute("disabled", "disabled");
...
var y=document.getElementById("qust_num").value;
console.log(y);
y=parseInt(y);
var d = new Date(valu);
