  			...
  			<div class="col-xs-12 no-padding">
  					...
  					<div class="piece-heading">
  						...
  						<div class="col-xs-2">
  							<label class="radio-inline">
  								<input type="radio"  checked name="inlineRadioOptions" id="inlineRadio1" value="option1"> <?php echo $agaza_data->no3_title; ?>
  							</label>
  						</div>
  					</div>
  					<div class="piece-body">
  						<div class="col-xs-12 no-padding">
  							<div class="col-xs-12 no-padding under-line">
  								<div class="col-xs-4">
  									<h6>الرقم الوظيفي<span class="valu"><?php echo $agaza_data->emp_id_fk; ?></span></h6>
  								</div>
  								<div class="col-xs-4">
  									<h6>اسم الموظف:<span class="valu"><?php echo $agaza_data->employee; ?></span></h6>
  								</div>
  								<div class="col-xs-4">
  									<h6>المسمى الوظيفي<span class="valu"><?php echo $agaza_data->job_title; ?></span></h6>
  								</div>
  							</div>
  							<div class="col-xs-12 no-padding under-line ">
  								<div class="col-xs-4">
  								...
  								<div class="col-xs-4">
  									<h6>تاريخ الطلب<span class="valu"><?php echo date('d-m-Y',$agaza_data->agaza_date);?></span></h6>
  								</div>
  							</div>
                ...
                $to =$to[2].'/'.$to[0].'/'.$to[1];
                  ...
                  ?>
  							<div class="col-xs-12 no-padding under-line ">
  								<div class="col-xs-6">
  									<h6>تاريخ بداية الإجارة من يوم &nbsp&nbsp&nbsp    <?php echo $agaza_data->agaza_from_day_n;?>  الموافق<span class="valu"><?php echo $from;?></span></h6>
  								</div>
  								<div class="col-xs-6">
  									<h6>تاريخ نهاية الأجازة من يوم &nbsp&nbsp&nbsp <?php echo $agaza_data->agaza_to_day_n;?> الموافق<span class="valu"><?php echo $to;?></span></h6>
  								</div>
  							</div>
  							<div class="col-xs-12 no-padding under-line ">
  								<div class="col-xs-6">
  									<h6>عدد أيام الإجازة المطلوبة : (  <?php echo $agaza_data->num_days;?> )  أيام/يوماً<span class="valu"></span></h6>
  								</div>
                  <?php
                  ...
                  $mobashret =$mobashret[2].'/'.$mobashret[0].'/'.$mobashret[1];
                    ...
                    ?>
  								...
  								<div class="col-xs-6">
                    <h6> تاريخ المباشرة للعمل : يوم <?php echo$agaza_data->mobashret_amal_day_n;?> الموافق <span class="valu"><?php echo $mobashret;?></span></h6>
  								</div>
  							</div>
  							<div class="col-xs-12 no-padding under-line ">
  								<div class="col-xs-8">
  									<h6>العنوان أثناء الإجازة<span class="valu"><?php echo $agaza_data->address_since_agaza;?></span></h6>
  								</div>
  								<div class="col-xs-4">
  							...
  							<div class="col-xs-12 no-padding under-line ">
  								<div class="col-xs-8">
  									<label class="radio-inline">
  										<input type="radio" checked name="inlineRadioOptions1" id="inlineRadio5" value="option1"> أتعهد بتسليم كل مهامي للموظف البديل والعودة من إجازتي في الموعد المحدد
  									</label>
  				...
  				<div class="piece-box">
  					...
  					<div class="piece-body">
  						<div class="col-xs-12 under-line ">
  							<div class="col-xs-6">
  								<h6>اسم الموظف : <span class="valu"><?= $personal_data->employee ?></span></h6>
  							</div>
  							<div class="col-xs-6">
                    ...
                    <?php if($agaza_data->action_emp_badel ==1){?>
                      <label class="radio-inline">
                          <input type="radio" name="action1"   checked value="option1"> أتعهد بأن أقوم باستلام جميع الأعمال الموكلة للموظف المذكورة أعلاه قبل موعد إجازته وتنفيذها في مواعيدها
                        </label>
                      <?php }elseif ($agaza_data->action_emp_badel ==2){ ?>
                        <input type="radio" name="action1" checked  id="tahod-2" data-validation="required" value="2">
        ...
        <label class="radio-inline"> أوافق على أجازة الموظف المذكور أعلاه وسيتم تسليم أعماله
                ...
                <?php }elseif ($agaza_data->action_direct_manager ==2){ ?>
  						<div class="col-xs-12 under-line">
  							...
  							<label class="radio-inline">
  								<input type="radio" checked name="action2" id="inlineRadio7" value="option1">  لا أوافق بسبب   <?php echo$agaza_data->reason_action; ?>
  							</label>
  						</div>
                  <?php   } ?>
  				...
  				<div class="piece-box" >
  					...
  					<div class="piece-body" >
  						...
  						<div class="col-xs-12 under-line ">
  							<div class="col-xs-4">
  								<h6>الموظف المختص : <span class="valu"><?php  if(!empty($level_2data->to_user_n)){ echo$level_2data->to_user_n;} ?></span></h6>
  							</div>
  							<div class="col-xs-4">
  								<h6>التوقيع : <span class="valu"></span></h6>
  							</div>
                    ...
                    <?php if($agaza_data->action_moder_hr ==1){?>
  							<div class="col-xs-12 under-line">
  								<label class="radio-inline">
  									<input type="radio"  checked name="inlineRadioOptions6" id="inlineRadio7" value="option1"> تم التأكد من جميع البيانات والتواقيع أعلاه ولا مانع من تمتع الموظف بالإجازة
  								</label>
  							</div>
                    <?php }elseif ($agaza_data->action_moder_hr ==2){ ?>
  							<div class="col-xs-12 under-line">
  								...
  								<label class="radio-inline">
  									<input type="radio" checked  name="inlineRadioOptions1" id="inlineRadio7" value="option1"> لا أوافق بسب   <?php echo$agaza_data->reason_action; ?>
  								</label>
  							</div>
                  <?php   } ?>
  						</div>
  						<div class="col-xs-12 under-line">
  							<div class="col-xs-4">
  								<h6>الإسم : <span class="valu"><?php  if(!empty($level_3data->to_user_n)){ echo$level_3data->to_user_n;} ?></span></h6>
  							</div>
  							<div class="col-xs-4">
  								<h6>التوقيع : <span class="valu"></span></h6>
  							</div>
