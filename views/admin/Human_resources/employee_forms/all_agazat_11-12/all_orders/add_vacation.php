                                    ...
                                    <div class="bond panel-default">
                                        ...
                                        <div class="bond-body">
                                            ...
                                            <div class="form-group col-md-4 col-sm-4 col-xs-6 padding-4">
                                                ...
                                                <input type="text" style="width:85%; float: right;" name="emp_badel_n" data-validation="required"
...
<script type="text/javascript">
    /*function checkValidateVacationDayes() {
        if ($('#no3_agaza').val() != ' ' && $('#emp_code_fk').val()) {
            var actualDayes = parseFloat($('#emp_code_fk option:selected').attr('allDayes')) - parseFloat($('#emp_code_fk option:selected').attr('vdayes'));
