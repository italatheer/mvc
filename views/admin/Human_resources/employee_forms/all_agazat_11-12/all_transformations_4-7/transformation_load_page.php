...
<div class="modal-body">
     <div class="col-sm-9 padding-4">
       <!--eslam-->
         ...
         <table class="table table-bordered" border="1" cellpadding="3" cellspacing="0" style="width:100%">
             ...
             <tr>
                 <td colspan="3" style="background-color:#e6eed5; border-color:#73b300">
                     ...
                     <input type="radio" name="action2" id="accept-radio"  disabled
                         <?php if($agaza_data->action_direct_manager ==1){  echo 'checked '; }?>

                            value="1">
                        <label class="radio-label" for="accept-radio">   أوافق على أجازة الموظف المذكور أعلاه وسيتم تسليم أعماله
                     للموظف البديل</label> 
                     ...
                     <input type="radio" name="action2"  id="reject-radio" disabled

                         <?php if($agaza_data->action_direct_manager ==2){  echo 'checked '; }?>
                            value="2"> 
                            
                         <label class="radio-label" for="reject-radio">   لا أوافق بسبب</label> 
         ...
         <table class="table table-bordered" border="1" cellpadding="3" cellspacing="0" style="width:100%">
             ...
             <tr>
                 <td>الإسم/<?= $level_3data->to_user_n ?></td>
                 <td>التوقيع/</td>
   ...
   ................... <?php } ?>"></td>
             ...
             <tr>
                 <td>الإسم/<?= $level_4data->to_user_n ?></td>
                 <td>التوقيع/</td>
    ...
    <?php if ($_POST['toUser'] == $_SESSION['user_id'] && $_POST['level'] == 1) { ?>
        <form enctype="multipart/form-data" method="post" id="form1" action="<?php echo base_url() ?>human_resources/employee_forms/all_agazat/all_transformations_f/All_transformations/saveTransformBadel">
            ...
            <input type="hidden" name="link_mobasher" id="link_mobasher" value="<?php echo $modeer_mobasher->user_photo;?>">
            <input type="hidden" name="name_mobasher" id="name_mobasher" value="<?php echo $modeer_mobasher->employee;?>">
            <input type="hidden" name="job_mobasher"  id="job_mobasher" value="<?php echo $modeer_mobasher->employee;?>">
            ...
            <div class="col-sm-12 padding-4" id="html">
                <table class="table table-bordered" border="1" cellpadding="3" cellspacing="0"  style="width:100%">
                    ...
                    <tr>
                        <td >الإسم/<?= $personal_data->employee ?></td>
                        <td>التوقيع/</td>
                        <td>التاريخ/<?= date('Y-m-d') ?></td>
                    </tr>
                    <tr>
                        ...
                        <div class="radio-content">
                            <input type="radio" onclick="change_photo(1)" id="tahod-1"
                             name="action" value="1">
                            ...
                            <div class="radio-content">
                            <input type="radio" name="action" onclick="change_photo(2)" id="tahod-2"
                                   value="2">
                            <label class="radio-label"  for="tahod-2"><input size="60" type="text" name="reason_action"
                                                    value="........................................"
                                                    style="border: none; background-color: rgba(0, 0, 0, 0);">
                              </label>
                            </div>
                ...
                <script>
                    ...
                    function change_photo(value) {
                        ...
                        if(value ==1){
                            ...
                            $('#empImg_1').attr('src', '<?php echo base_url() . "uploads/images/"; ?>' + link);
    ...
    <form enctype="multipart/form-data" method="post" id="form2"  action="<?php echo base_url() ?>human_resources/employee_forms/all_agazat/all_transformations_f/All_transformations/saveTransformDirectManger">
        ...
        <table class="table table-bordered" border="1" cellpadding="3" cellspacing="0" style="width:100%">
            ...
            <tr>
                <td colspan="3" style="background-color:#e6eed5; border-color:#73b300">
                    <input type="radio" name="action" onclick="change_photo_DirectManger(1)"
...
change_photo_DirectManger(2)
        ...
        <?php if ($_POST['toUser'] == $_SESSION['user_id'] && $_POST['level'] == 3) { ?>
            ...
            <form enctype="multipart/form-data" method="post" id="form3"
                ...
                <table class="table table-bordered" border="1" cellpadding="3" cellspacing="0" style="width:100%">
                    ...
                    <tr>
                        <td colspan="4" style="background-color:#e6eed5; border-color:#73b300">
                            <input type="radio" name="action"  onclick="change_photo_DirectMange2r(1)" value="1">أوافق<br>
                            <input type="radio" name="action"  onclick="change_photo_DirectMange2r(2)" value="2"> لا أوافق بسبب
                            <input size="60" type="text" name="reason_action" value=" ..................."></td>
                    </tr>
                    </tbody>
                </table>
        ...
        <input type="hidden" name="to_user_n" id="to_user_n" value="<?= $agaza_data->direct_manager_n ?>">-->
                ...
                <table class="table table-bordered" border="1" cellpadding="3" cellspacing="0" style="width:100%">
                    ...
                    <tr>
                        <td colspan="3" style="background-color:#e6eed5; border-color:#73b300">
                            <input type="radio" name="action"  onclick="change_photo_DirectMange3r(1)"
                                   value="1">تم التأكد من جميع البيانات والتواقيع أعلاه ولا
                            مانع من تمتع الموظف بالأجازة<br>
                            <input type="radio" name="action" onclick="change_photo_DirectMange3r(2)"  value="2"> لا أوافق بسبب
                            <input size="60" type="text" name="reason_action" value=" ..................."></td>
                    </tr>
                    <tr>
                        <td>الإسم/<?= $personal_data->employee ?></td>
