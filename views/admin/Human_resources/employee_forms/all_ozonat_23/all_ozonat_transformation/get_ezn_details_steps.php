...
<div class="col-md-9">
    ...
    <div class="col-md-3">
        ...
        <?php if(isset($row->personal_emp_img)&& !empty($row->personal_emp_img)){?>
            <img id="empImg" src="<?php echo base_url();?>uploads/human_resources/emp_photo/thumbs/<?php echo $row->personal_emp_img ;?>" width="100" height="150" alt="">
        <?php } else{  ?>
            <img  id="empImg" src="<?php echo base_url();?>asisst/admin_asset/img/user.png" width="100" height="150" alt="">
        <?php } ?>
