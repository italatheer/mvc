...
if (isset($emp_name) && !empty($emp_name)){?>
        ...
        <span class="profile-picture">
           ...
           <?php if(isset($emp_name->personal_photo)&& !empty($emp_name->personal_photo)){?>
                    <img id="profile-img-tag"   src="<?php echo base_url();?>uploads/human_resource/emp_photo/thumbs/<?php echo $emp_name->personal_photo ;?>" class="editable img-responsive" alt="Alex's Avatar">
               
               
                <?php } else{  ?>
                    <img id="profile-img-tag"  class="editable img-responsive" alt="Alex's Avatar"   src="<?php echo base_url();?>asisst/fav/apple-icon-120x120.png" >
                <?php } ?>
