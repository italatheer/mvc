                ...
                <form action="<?php echo base_url(); ?>human_resources/employee_forms/Volunteer_hours/add_volunteer_hours"
                    ...
                    <div class="col-xs-12 no-padding">
                        ...
                        <div class="col-md-3 form-group padding-4">
                            ...
                            <input type="text" id="job" name="job" value="<?= $job ?>" data-validation="required"
                                   class="form-control">
                        </div>
                        ...
                        <div class="col-md-2 form-group padding-4">
                            ...
                            <input type="text" id="tele" name="tele" maxlength="10" onkeyup="check_len($(this).val());"
                                   data-validation="required" value="<?= $tele ?>" onkeypress="validate_number(event)"
                                   class="form-control">
                        ...
                        <div class="col-md-2 form-group padding-4">
                            ...
                            <input type="text" id="mob" name="mob" maxlength="10" onkeyup="check_len($(this).val());"
                                   data-validation="required" value="<?= $mob ?>" onkeypress="validate_number(event)"
                                   class="form-control">
                        </div>
                        <div class="col-md-2 form-group padding-4">
                            <label class="label ">البريد الألكتروني </label>
                            <input type="email" id="email" name="email" value="<?= $email ?>" data-validation="required"
                                   class="form-control">
                        </div>
                ...
                <table id="example" class=" display table table-bordered   responsive nowrap" cellspacing="0"
                    ...
                    foreach ($records as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a data-toggle="modal" data-target="#detailsModal" class="btn btn-xs btn-info"
