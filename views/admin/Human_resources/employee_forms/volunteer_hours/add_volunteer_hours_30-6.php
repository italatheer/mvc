            ...
            <?php
                ...
                foreach ($records as $row) {
                    ...
                    <tr>
                        ...
                        <td><a type="button" class="btn btn-info btn-xs" style="padding: 1px 6px;" title="التفاصيل" data-toggle="modal" data-target="#myModal<?php echo$row->id; ?>"><i class="fa fa-list"></i></a>
