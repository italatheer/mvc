			...
			<div class="print_forma  col-xs-12">
				...
				<div class="piece-box" style="margin-top: 20px">
					<div class="piece-heading">
						...
						<!-- <div class="col-xs-3">
							<label class="radio-inline">
								<i class="fa <?php echo $class2; ?>"></i>  استئذان للعمل
							</label>
						</div> -->
					...
					<div class="piece-body">
						<div class="col-xs-12 no-padding">
							<div class="col-xs-12 no-padding under-line">
								<div class="col-xs-4">
									<h6>الرقم الوظيفي:<span class="valu"><?php if (isset($ezn_data) &&(!empty($ezn_data))) { echo $ezn_data->emp_code_fk ;}?> </span></h6>
								</div>
								<div class="col-xs-4">
									<h6>اسم الموظف:<span class="valu"><?php if (isset($ezn_data) &&(!empty($ezn_data))) { echo $ezn_data->emp_name ;}?></span></h6>
								</div>
								<div class="col-xs-4">
									<h6>المسمى الوظيفي:<span class="valu"><?php if (isset($ezn_data) &&(!empty($ezn_data))) { echo $ezn_data->job_title ;}?></span></h6>
								</div>
							</div>
							<div class="col-xs-12 no-padding under-line open_green">
								<div class="col-xs-4">
									<h6>الإدارة:<span class="valu"><?php if (isset($ezn_data) &&(!empty($ezn_data))) { echo $ezn_data->edara_n ;}?></span></h6>
								</div>
								<div class="col-xs-4">
									<h6>تاريخ الإذن :<span class="valu"><?php if (isset($ezn_data) &&(!empty($ezn_data))) { echo $ezn_data->ezn_date_ar ;}?></span></h6>
								</div>
								<div class="col-xs-4">
									<h6>الفترة :<span class="valu"><?php if (isset($ezn_data) &&(!empty($ezn_data))) { echo $ezn_data->fatra_n ;}?></span></h6>
								</div>
							</div>
							<div class="col-xs-12 no-padding under-line">
								<div class="col-xs-4">
									<h6>وقت البداية :<span class="valu"><?php if (isset($ezn_data) &&(!empty($ezn_data))) { echo $ezn_data->from_hour ;}?></span></h6>
								</div>
								<div class="col-xs-4">
									<h6>وقت النهاية :<span class="valu"><?php if (isset($ezn_data) &&(!empty($ezn_data))) { echo $ezn_data->to_hour ;}?></span></h6>
								</div>
								<div class="col-xs-4">
									<h6>المدة :<span class="valu"><?php if (isset($ezn_data) &&(!empty($ezn_data))) { echo $ezn_data->total_hours ;}?></span></h6>
								</div>
							</div>

							<div class="col-xs-12  under-line ">
								<h6>&nbsp السبب :<span class="valu"><?php if (isset($ezn_data) &&(!empty($ezn_data))) { echo $ezn_data->reason ;}?></span></h6>
							</div>
				...
				<div class="piece-box">
					...
					<div class="piece-body">
						...
						<?php } ?>
							<!-- <div class="col-xs-12">
								<label class="radio-inline">
									<i class="fa fa-circle"></i>  يقبل عذره ويعفي من الحسم
								</label>
							</div>
							<div class="col-xs-12">
								<label class="radio-inline">
									<i class="fa fa-circle-o"></i> يعتمد الحسم عليه بعدد ساعات الاستئذان
								</label>
							</div> -->
