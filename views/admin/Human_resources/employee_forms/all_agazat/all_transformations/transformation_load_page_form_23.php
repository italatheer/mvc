...
<div class="modal-body">
    <div class="col-sm-9 padding-4">
        ...
        <form enctype="multipart/form-data" method="post" id="form1"
              action="<?php echo base_url() ?>human_resources/employee_forms/all_agazat/all_transformations_f/All_transformations/saveTransform">
            ...
            <div class="col-sm-12 padding-4" id="html">
                            ...
                            <td colspan="3" style="background-color:#e6eed5; border-color:#73b300">
                                <div class="radio-content">
                                    ...
                                    $('#reason_action1').val('................');" id="tahod-1"
                                           data-validation="required" name="action" value="1">
                            ...
                            <td colspan="3" style="background-color:#ffb3b7; border-color:#73b300">
                                ...
                                <div class="radio-content">
                                    <input type="radio" name="action" onclick="change_photo(2);
                                            ...
                                            $('#current_to_id').removeAttr('data-validation');" id="tahod-2"
                        ...
                        <tr>
                            ...
                            $('#current_to_id').attr('data-validation','required');
                                $('#reason_action2').attr('disabled',true);" value="1">
                                    ...
                                    <label class="radio-label" for="accept-1"> أوافق على أجازة الموظف المذكور أعلاه
                                        وسيتم تسليم أعماله
                                        للموظف البديل </label>
                        ...
                        <?php if ($agaza_data->current_to_user_id == $_SESSION['user_id'] && ($agaza_data->level == 3)) { ?>
                            ...
                            <tr>
                                <td colspan="4" style="background-color:#ffb3b7; border-color:#73b300">
                                    ...
                                    <div class="radio-content">
                                        <input type="radio" name="action" data-validation="required" id="accept-2"
                                               onclick="change_photo(2);$('#reason_action3').removeAttr('disabled');$('#current_to_id').removeAttr('data-validation'); "
                                               value="2">
                            ...
                            <tr>
                                <td colspan="4" style="background-color:#e6eed5; border-color:#73b300">
                                    <div class="radio-content">
                                        ...
                                        <label class="radio-label" for="accept-1">تم التأكد من جميع البيانات والتواقيع
                                            أعلاه ولا
                ...
                <?php if (key_exists($agaza_data->level, $arr_select_lable)) { ?>
                    <div class="form-group col-md-6 col-sm-6 padding-4">
                        ...
                        <select data-validation="required" name="current_to_id" id="current_to_id" class="form-control"
                            ...
                            <?php if (isset($employees_data) && !empty($employees_data)) {
                                foreach ($employees_data as $row) { ?>
                                    <option value="<?= $row->person_id ?>" data-img="<?= $row->person_img ?>"
                                            ...
                                            data-job="<?= $row->job_title_n ?>"><?= $row->person_name ?></option>
                                <?php }
                            } ?>
                        </select>
