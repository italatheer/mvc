        ...
        <div class="col-xs-12 no-padding text-center" style="margin-bottom: 5px;">
            <a href="#modal_details" data-toggle="modal" onclick="get_details()">
                <div class="box-register">
                    <img
                        src="<?php echo base_url(); ?>/asisst/admin_asset/img/icons/846-8467960_regulation-rules-and-regulation-icon.png">
                    <h5>ضوابط الدعم</h5>
                </div>
            </a>
        ...
        <div class="roundedBox">
            ...
            ?>
                ...
                <div class="col-sm-12 no-padding">
                    ...
                    ?>
                    <form
                        action="<?php echo base_url() . 'human_resources/employee_forms/solaf/Solaf/edit_solaf/' . $item->id; ?>"
                            ...
                            <div class="col-md-12 no-padding">
                                ...
                                <div class="col-md-2  padding-4">
                                    ...
                                    <input type="date" name="t_rkm_date_m" id="t_rkm_date_m"
                                        value="<?= $t_rkm_date_m;?>" class="form-control  " data-validation="required"
                                        data-validation-has-keyup-event="true">
                                </div>
      ...
      -->
                                ...
                                <div class="form-group col-md-3 col-sm-6 col-xs-6 padding-4">
                                    ...
                                    <input name="emp_name" id="emp_name" class="form-control"
                                        style="width:86%; float: right;" readonly value="<?php if (!empty($emp_data->employee)) {
                                ...
                                <div class="form-group col-md-2 col-sm-6 col-xs-6 padding-4">
                                    ...
                                    <input style="padding-right: 0px !important;" name="edara_n" id="edara_n"
                                        class="form-control" value="<?php if (!empty($emp_data->administration_name)) {echo $emp_data->administration_name;
                                           } else { echo $edara_n;
                                           } ?>" readonly>
                                </div>
                                <div class="form-group col-md-3 col-sm-6 col-xs-6 padding-4">
                            ...
                            ?>
                                ...
                                <div class="form-group col-md-1  col-sm-6 col-xs-6  padding-4">
                                    ...
                                    <input type="text" name="qst_num" id="qst_num" onchange="Getdiv(this.value)"
                                        ...
                                        <?php if ($sadad_solfa == 1 && $sadad_solfa == 2){ ?>disabled="disabled"
                                        <?php } ?> class="form-control " data-validation="required"
                                ...
                                <div class="form-group col-md-2  col-sm-6 col-xs-6  padding-4">
                                    ...
                                    <input type="text" id="num_previous_requests" name="num_previous_requests"
                                        value="<?=$num_previous_requests; ?>" class="form-control "
                                        data-validation="required" onkeypress="validate_number(event);"
                                        data-validation-has-keyup-event="true">
                                ...
                                <div class="col-md-2  padding-4">
                                    ...
                                    <input type="date" name="previous_request_date_m" id="previous_request_date_m"
                                        value="<?= $previous_request_date_m;?>" class="form-control  "
...
-->
                                ...
                                <div class="form-group col-md-2  col-sm-6 col-xs-6  padding-4">
                                    ...
                                    <input type="date" name="khsm_to_date_m" id="khsm_to_date_m"
                                        value="<?= $khsm_to_date_m;?>" class="form-control  " data-validation="required"
                                        data-validation-has-keyup-event="true">
                                </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#modal_details" data-toggle="modal"
                            onclick="get_solfa_details(<?php echo $row->t_rkm;?>)"> <i class="btn fa fa-list"></i></a>
...
if($row->suspend == 0){ ?>
                        <?php if(!empty($row->current_to_user_id)) {
                            ...
                            $trans_diapled= 'disabled';
                        }else {
                            $text_trans=' تحويل الطلب';
                            $trans_diapled= '';

                        } ?>
                        <a onclick="make_transformation_direct(<?= $row->id?>)" class="btn btn-warning"
                            <?=$trans_diapled?> id="transform_direct<?= $row->id?>"><?=$text_trans?></a>
                        <a onclick='swal({
        ...
        setTimeout(function(){window.location="<?= base_url() . 'human_resources/employee_forms/solaf/Solaf/delete_solfa/' . $row->id. '/' . $link_delete; ?>";}, 500);
                        ...
                        <span class="label label-danger">
                            عذرا لا يمكنك التعديل والحذف والتحويل
                        </span>
    ...
    $.ajax({
        ...
        success: function(d) {
            if (d == 1) {
                ...
                $("#transform_direct").attr("disabled", true);
