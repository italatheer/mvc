                                    ...
                                    <div class="bond panel-default">
                                        ...
                                        <div class="bond-body">
                                            <div class="form-group col-md-8 col-sm-8 col-xs-12 padding-4">
                                                <label style="    margin-top: 20px;"> <input type="checkbox"  name="pledge" id="pledge" value="1"  data-validation="required" >
                                                    اتعهد بتسليم
                                                    كل
                    ...
                    if (isset($items) && !empty($items)) {
                        ...
                        foreach ($items as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a type="button" class="btn btn-info btn-xs" style="padding: 1px 6px;" data-toggle="modal" title="التفاصيل"
