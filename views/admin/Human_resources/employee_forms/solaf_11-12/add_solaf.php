                        ...
                        <form action="<?php echo base_url(); ?>human_resources/employee_forms/solaf/Solaf/add_solaf"
                            ...
                            ?>
                                ...
                                <div class="form-group col-md-1  col-sm-6 col-xs-6  padding-4">
                                    ...
                                    <input type="text" name="qst_num" id="qst_num" onchange="Getdiv()"
...
<div id="option_td<?= $row->id?>" style="display:<?=$trans_diapled?>">
                        ...
                        <a onclick="make_transformation_direct(<?= $row->id?>)" class="btn btn-warning"
                             id="transform_direct<?= $row->id?>"><?=$text_trans?></a>
                        <a onclick='swal({
    ...
    <div class="modal-dialog" role="document" style="width: 95%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 style="color: white !important;" class="modal-title" id="myModalLabel">تفاصيل السلفه</h4>
            </div>
