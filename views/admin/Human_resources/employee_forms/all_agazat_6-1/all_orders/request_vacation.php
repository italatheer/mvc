...
<?php if ($_SESSION['role_id_fk'] == 1) {
  ...
  <a title="تعديل الطلب - قطع الأجازة" href="<?php echo base_url(); ?>human_resources/employee_forms/all_agazat/all_orders/Vacation/edit_vacation/<?php echo $row->id.'/1'; ?>"><i
