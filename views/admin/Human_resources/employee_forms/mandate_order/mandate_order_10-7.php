                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="col-md-1 form-group  padding-4">
                        ...
                        <input type="text" value="<?php echo $mandate_distance; ?> " data-validation="required"
                               onkeypress="validate_number()" class="form-control" name="mandate_distance">
                    </div>
                ...
                <div class="col-md-12">
                    <div class="col-xs-7 col-xs-offset-2">
                        <div class="form-group">
                            ...
                            <button type="button" id="save" onclick="add_option($('#destin').val());"
                                    class="btn btn-danger" style="float: left" data-dismiss="modal">حفظ
                            </button>
