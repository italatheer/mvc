        ...
        <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable col-xs-12 no-padding ">
            ...
            <div class="col-xs-12 no-padding">
                    ...
                    if(isset($evaluation) && !empty($evaluation) && $evaluation!=null){
                        $emp_name = $evaluation->emp_name;
                        $edara_name = $evaluation->edara_name;
                        $qsm_name = $evaluation->qsm_name;
                        $job_title = $evaluation->job_title;
                        $date_from_m= $evaluation->date_from_m;
                ...
                <div class="col-xs-12 no-padding  ">
                    ...
                    <div class="col-xs-4 form-group">
                        ...
                        <span class="btn btn-success "  onclick="$(this).attr('readonly','readonly'); $('#myModal').modal('show');" style="float: right;"><i class="fa fa-plus"></i></span>
