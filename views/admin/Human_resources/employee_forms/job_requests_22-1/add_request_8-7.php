                ...
                <div class="col-md-12 no-padding">
                   <!-- <div class="form-group col-md-3   ">
                       ...
                       <div class="form-group col-md-3  padding-4 ">
                        ...
                        <input type="hidden" name="dep_id_fk" id="dep_id_fk">
                        <input type="hidden" name="sub_dep_id_fk" id="sub_dep_id_fk">
                        <button class="btn btn-success "  onclick="$(this).attr('readonly','readonly'); $('#myModal').modal('show');" style="float: right;"><i class="fa fa-plus"></i></button>
                    </div>
                    ...
                    <div class="form-group col-md-3 col-sm-6  padding-4  ">
                        ...
                        <select id="job_natural" data-validation="required" class="form-control   selectpicker"
                                data-show-subtext="true" data-live-search="true"
                                name="job_natural">
                            <option value="">إختر</option>
                            <?php
                    ...
                    <table class="table table-striped table-bordered"  id="mytable_reasons">
                        ...
                        if ((isset($get_requset->reasons)) && !empty($get_requset->reasons)) {
                            ...
                            foreach ($get_requset->reasons as $reson) {
                                ...
                                <tr id="row_<?= $z ?>">
                                    <td><?= $z ?></td>
                                    <td><input type="text" name="details_reason[]"  class="form-control testButton inputclass"
                                               id="details_reason<?= $z ?>"
                                               value="<?= $reson->details ?>"
                                               /></td>
                            ...
                            <tr id="row_1">
                                <td>1</td>
                                <td><input type="text" name="details_reason[]" placeholder="الاسباب والمبررات" class="form-control testButton inputclass"
                        ...
                        <tr class="">
                            <th colspan="3">
                            <button type="button" onclick="add_row()" class="btn-success btn btn-labeled"><span class="btn-label"><i
                        ...
                        <table class="table table-striped table-bordered"  id="mytable_reasons">
                            ...
                            if ((isset($get_requset->requests)) && (!empty($get_requset->requests))) {
                                ...
                                foreach ($get_requset->requests as $request) {
                                    ...
                                    <tr id="row_<?= $z ?>">
                                        <td><?= $z ?></td>
                                        <td><input type="text" name="details_need[]" class="form-control testButton inputclass"
                                                   id="details_need<?= $z ?>"
                                ...
                                <tr id="row_1">
                                    <td>1</td>
                                    <td><input type="text" name="details_need[]" placeholder="المتطلبات" class="form-control testButton inputclass"
                            ...
                            <tr class="">
                                ...
                                <th colspan="3">
                                <button type="button" onclick="add_row_need()" class="btn-success btn btn-labeled"><span class="btn-label"><i
                                            class="fa fa-plus"></i> </span>إضافة
                                </button>
