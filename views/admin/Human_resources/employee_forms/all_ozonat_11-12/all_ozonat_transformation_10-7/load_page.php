...
?>
    <table class="table table-bordered" id="ezn_table">
        <thead>
        ...
        <?php if(isset($records)&& !empty($records)){
            ...
            ?>
                <tr id="row<?php echo $row->id;?>">
                    ...
                    <td> <button class="btn btn-primary"  onclick="load_ezn_details(<?php echo $row->id;?>);" data-target="#detailsezn" data-toggle="modal">تفاصيل الاذن</button></td>
                    <td>
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="display: inline-block;width: 100%;">
                <button type="button"  onclick="make_suspend();"  class="btn btn-labeled btn-success">
                    <span class="btn-label"><i class="glyphicon glyphicon-remove"></i></span>ارسال
                </button>
