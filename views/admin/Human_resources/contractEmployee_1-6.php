...
<div class="form-group col-sm-3 col-xs-12">
	...
	<input type="text" name="emp_code"  readonly=""  value="<?php if($employee_data != null){ echo $employee_data['emp_code'];  }else{}?>" class="form-control bottom-input"  />
</div>
...
<div class="form-group col-sm-3 col-xs-12">
	...
	<input type="text" name="emp_name"  readonly=""  value="<?php if($employee_data != null){ echo $employee_data['employee'];  }else{}?>" class="form-control  bottom-input"  />
              ...
              <!--  <input type="hidden" name="emp_salary"  id="emp_salary"   value="<?php if($employee_data != null){ echo $employee_data['salary'];  }else{}?>" class="form-control  bottom-input"  />
                ...
                <div class="form-group col-sm-3 col-xs-12">
				   <label class="label top-label">طبيعة العقد</label>
                    <select name="contract_nature"  class=" no-padding form-control bottom-input"   data-validation="required"  aria-required="true"   >
               ...
               <div class="form-group col-sm-3 col-xs-12">
    <label class="label top-label">طبيعة العمل</label>
    <select name="job_type"  class=" no-padding form-control bottom-input"   data-validation="required"  aria-required="true"   >
        <option value=""> إختر  </option>
        <?php
        ...
        ?>
            ...
            <div class="col-sm-12 col-xs-12">
				<div class="form-group col-sm-3 col-xs-12">
					<label class="label top-label">إيام العمل خلال الشهر </label>
					<input type="number" name="num_days_in_month" id="num_days_in_month"  
                    onkeyup="getHourSalary()"
                    <?=$disabled?> value="<?php echo $result['num_days_in_month']?>" onkeyup="return load_price();" class="form-control bottom-input"  data-validation="required" />
				</div>
                   
                <div class="form-group col-sm-3 col-xs-12">
					<label class="label top-label">ساعات العمل </label>
					<input type="number" name="hours_work" id="hours_work"
                    onkeyup="getHourSalary()"
                      <?=$disabled?> value="<?php echo $result['hours_work']?>" onkeyup="return load_price();" class="form-control  bottom-input" data-validation="required"  />
                ...
                <div class="form-group col-sm-3 col-xs-12">
               	...
               	<div class="form-group col-sm-3 col-xs-12">
				    <label class="label top-label">فترات العمل</label>
            ...
            <div class="col-sm-12 col-xs-12">
		    	<div class="form-group col-sm-3 col-xs-12">
				    <label class="label top-label">الأجازة السنوية </label>
               ...
               <div class="form-group col-sm-3 col-xs-12">
                ...
                <div class="form-group col-sm-3 col-xs-12">
					<label class="label top-label">المدة المستحقة عنها</label>
                   <select name="year_vacation_period" id="year_vacation_period"  class="form-control bottom-input"   data-validation="required"  aria-required="true"   >
                 ...
                 <div class="form-group col-sm-3 col-xs-12">
					<label class="label top-label">رصيد الاجازة السنوية السابقة </label>
                    <input type="number" name="vacation_previous_balance" value="<?php echo $result['vacation_previous_balance'];?>"    class=" form-control bottom-input" data-validation="required"   >   
                </div>
                
                 <div class="form-group col-sm-3 col-xs-12">
					<label class="label top-label">بداية حساب الاجازة</label>
                    <input type="text" name="vacation_start" value="<?php  echo $result['vacation_start_ar'];?>"    class="date_as_mask form-control bottom-input" data-validation="required"   >
                </div>
                ...
                <div class="form-group col-sm-3 col-xs-12">
                 ...
                 <?php
                  if($result['travel_ticket'] && $result['travel_ticket'] == 2){
                    ...
                    ?>
         	<div class="form-group col-sm-3 col-xs-12">
				    <label class="label top-label">نوع التذكرة</label>
               ...
               <div class="form-group col-sm-3 col-xs-12">
                ...
                -->
					...
					<label class="label top-label">تحديد المدة </label>
                   <select name="travel_period" id="travel_period" <?=$disabl2?> class="form-control bottom-input"    aria-required="true"   >
                       <option value="">أختر</option>
                       <?php
       ...
       <div class="col-sm-12 col-xs-12">
		    	<div class="form-group col-sm-3 col-xs-12">
				    <label class="label top-label">طريقة دفع الراتب </label>
