<?php if(!empty($result)){ ?>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group col-sm-4 col-xs-12">
            ...
            <select id="" name="always_id_fk"   disabled class="selectpicker no-padding form-control choose-date form-control half"  data-show-subtext="true" data-live-search="true"  data-validation="required"  aria-required="true" >
                ...
                <?php if(!empty($settings)){  foreach ($settings as $record){
                    $select='';
                    if($record->id == $this->input->post('update_id')){
                        $select='selected';
                    } ?>
        ...
        <div class="form-group col-sm-4 col-xs-12">
            ...
            <select id="" name="period_id_fk" disabled class="selectpicker no-padding form-control choose-date form-control half"  data-show-subtext="true" data-live-search="true"  data-validation="required"  aria-required="true"  onchange="getTimeNum(this.value)">
                <option value="">إختر</option>
                <?php
                for ($a=1;$a<=4;$a++){
                    $select='';
    ...
    <div class="col-md-12" id="">
        ...
        if(!empty($period_num)){  for ($a=0;$a<sizeof($days_ar);$a++){ ?>
        ...
        <?php }  ?>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <?php  $x=1;for ($a=0;$a<$period_num;$a++){     ?>
