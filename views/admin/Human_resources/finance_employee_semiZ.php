...
<div class="col-sm-9 col-md-9 col-xs-12 ">
    ...
    <table class="display table table-bordered responsive nowrap" id="POITable" cellspacing="0" width="100%" style="table-layout: auto;">
        <thead>
            ...
            <tr class="green_background">
                <input type="hidden" value="<?php if(isset($allData->badlat)&&!empty($allData->badlat)){echo $allData->get_having_value; } else { echo 0 ; }?> " name="db_value_have" id="db_value">
                <input type="hidden" value="<?php if(isset($allData->badlat)&&!empty($allData->badlat)){echo $allData->tamin_value; } else { echo 0; }?> " name="db_value_have2" id="db_value_tamin">

                <td colspan="2">إجمالي بنود الإستحقاقات</td>
                <td><input type="text"  readonly="readonly" name="having_all_value" class="form-control" value="<?php if(isset($allData->badlat)&&!empty($allData->badlat)){echo $allData->get_having_value; } ?> " id="all_value1"></td>
                <td colspan="3"  >اجمالي البنود الخاضعه للتأمينات</td>
                <td><input type="text" readonly="readonly" name="having_tamin_value"  class="form-control" value="<?php if(isset($allData->badlat)&&!empty($allData->badlat)){echo $allData->tamin_value; }  ?>" id="checked_value1"></td>
                <td></td>
                <td></td>
            </tr>
                        ...
                        foreach ($allData->badlat as $record) {
                                ...
                                if (isset($record->badalat) &&!empty($record->badalat)&&in_array($record->badalat->badl_discount_id_fk, $cuts_id)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select  disabled="disabled" class="badl_setting2" name=""
                                                    id="db_band_name<?php echo $record->badalat->badl_discount_id_fk; ?>"
                                                    class="form-control"
                                                    data-validation="required">
...
-->
                ...
                <tr class="red_background">
                    ...
                    <td><input type="text" readonly="readonly" class="form-control" name="discut_all_value" value="<?php if(isset($allData->badlat)&&!empty($allData->badlat)){echo $allData->get_discut_value; } ?> " id="all_value2"></td>
            ...
            <button onclick="get_bank();"
            type="button" class=" btn btn-add"> اضافه بنك</button>
            
            <table class="display table table-bordered responsive nowrap"  id="banktable" cellspacing="0" width="100%">
                <thead>
                    <tr class="info">
                        <th>إسم البنك</th>
                        <th>كود البنك</th>
                ...
                <div class="modal-dialog" role="document" style="width: 80%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                    aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="myModalLabemodal_having<?php echo $record->badalat->id; ?>">تعديل
                                استحقاقات
                                الموظف</h4>
                        </div>
                        ...
                        <div class="modal-body row">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control half" onchange="limit_peroid($(this).val(),<?php echo $record->badalat->id;?>);" data-validation="required" aria-required="true"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control half" name="have_date_from" type="date"
                                           value="<?php if ($record->badalat->specific_period == 1) {
                                               echo $record->badalat->date_from;
                                           } ?>" class="form-control" id="have_date_from<?php echo $record->badalat->id;?>" data-validation="required" style="width: 130px;" <?php  if($record->badalat->specific_period!=1) {  echo 'disabled';  } ?>>

                                </div>

                                <div class="col-md-4">
                                    <label class="label label-green  half">الي تاريخ </label>
                                    <input class="form-control half" type="date" name="have_date_to" id="have_date_to<?php echo $record->badalat->id;?>"
                                           value="<?php if ($record->badalat->specific_period == 1) {
                                               echo $record->badalat->date_to;
                                           } ?>" class="form-control" data-validation="required" style="width: 130px;" <?php  if($record->badalat->specific_period!=1) {  echo 'disabled';  } ?>>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <label class="label label-green  half">القيمه </label>
                                    <input class="form-control half" name="have_value" type="text" data-validation="required" value="<?php echo $record->badalat->value;?>" class="form-control">
