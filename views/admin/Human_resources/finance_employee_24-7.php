                        ...
                        <div class="modal-body row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input name="have_dalel_code" id="have_dalel_code1<?= $record->id?>" class="form-control"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body row">
                            <input type="hidden" name="having_row_id" value="<?php echo $record->badalat->id; ?>">
                                ...
                                <div class="col-md-3">
                                    <label class="label  ">الدليل</label>
                                    <input name="have_dalel_code" id="have_dalel_code2<?php echo $record->id;?>" class="form-control"
                                           value="<?php if (!empty($record->badalat->dalel_code)){echo $record->badalat->dalel_code;} else{echo 'لا يوجد';} ?>" readonly>
