            ...
            <div class="col-sm-12 form-group">
                ...
                <div class="col-sm-3  col-md-4 padding-4 ">
                    ...
                    <input type="text" name="mem_name" id="mem_name" readonly
                           ...
                           class="form-control " style="width: 85%;float: right">
                         ...
                         <span style="font-size: 12px; color: white !important; font-weight: normal;width: 141px;"
                            ...
                            <td>
                                <a type="button"
                                   ...
                                   data-target="#detailsModal" onclick="details(<?= $value->id ?>)"
                                ...
                                <a
                                        onclick='swal({
                                                ...
                                                function(){
                                                window.location="<?php echo base_url() . 'md/da3wat_gam3ia_omomia/Da3wat_gam3ia_omomia/edit/' . $value->id ?>";
                                                });'
                                ...
                                <a onclick=' swal({
                                        ...
                                        setTimeout(function(){
                                        window.location = "<?php echo base_url(); ?>md/da3wat_gam3ia_omomia/Da3wat_gam3ia_omomia/delete_dawat/<?= $value->id ?>";
                                        }, 500);
