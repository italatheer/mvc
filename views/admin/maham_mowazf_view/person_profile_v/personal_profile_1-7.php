...
<div id="user-profile-1" class="user-profile row">
        ...
        <div class="sidebar-shortcuts" id="sidebar-shortcuts">
            <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
                ...
                <ul class="nav nav-tabs" role="tablist" id="myTabs">
                    ...
                    <li role="presentation" class="<?php if (($currentURL == 'profile') || (empty($currentURL))) {
                        echo 'active';
                    } ?>">
                        <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"
                           style="background-color: #85b558;color: #fff;"
                           title="ملف الموظف بالجمعية">
                    ...
                    <li role="presentation" class="<?php if ($currentURL == 'agaza_order') {
                        echo 'active';
                    } ?>">
                        <a href="#agaza_order" aria-controls="agaza_order" role="tab" data-toggle="tab"
                           style="background-color: #0088b1;color: #fff;" title="طلب أجازة">
                            <i class="ace-icon fa fa-address-card-o faa-vertical animated"></i> طلب أجازة
                        </a>
                    </li>

                    <li role="presentation" class="<?php if ($currentURL == 'ezn_order') {
                        echo 'active';
                    } ?>">
                        <a href="#ezn_order" aria-controls="ezn_order" role="tab" data-toggle="tab"
                           style="background-color: #da9300;color: #fff;" title="الأذونات">
    ...
    <div class="col-xs-12 col-sm-10">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane  <?php if ($currentURL == 'ezn_order') {
                echo 'active';
            } ?>" id="ezn_order">
            </div>
...
<script>
    $('#myTabs a[href="#profile"]').click(function (e) {
        e.preventDefault();
        $(this).tab('show');
        console.log("click profile" + $(this));
    });
    ...
    $('#myTabs a[href="#ezn_order"]').click(function (e) {
        e.preventDefault();
        $('#ezn_order').html('');
