...
<?php else :?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade "  id="myModal<?php echo $record->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                <div class="modal-dialog modal-lg" id="printablediv<?php echo $record->id ?>"  >
                                                                        ...
                                                                        <div class="col-xs-12 r-pop-table">
                                                                            <div class="col-xs-6 r-table-padding">
                                                                                ...
                                                                                <div class="col-xs-6 r-table-padding r-input">
                                                                                    <h4 class="r-inner-h4"> <?php echo date('Y-m-d', strtotime($record->date)); ?></h4>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-xs-12 r-pop-table">
                                                                                <div class="col-xs-6 r-table-padding">
  ...
  <?php if(isset($images[$record->id]) && !empty($images[$record->id]) && $images[$record->id]!=null){?>
                                                                    <div class="col-xs-12">
...
<?php if(isset($signatures[$record->id]) && !empty($signatures[$record->id]) && $signatures[$record->id]!=null){?>
                                                                    <div class="col-xs-12">
                                                                        <table style="width:100%">
