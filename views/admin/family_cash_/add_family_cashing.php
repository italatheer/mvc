...
<div class="col-xs-12" >
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-12">
                ...
                <div class="form-group col-sm-4">
                    ...
                    <select name="method_type" onchange="get_method_type(this.value);" class="form-control half" data-validation="required" aria-required="true" tabindex="-1" aria-hidden="true">
      ...
      <div class="form-group col-sm-4 col-xs-12">
           ...
           <input type="text" class=" no-padding form-control form-control half" name="about" />
            </div>
            ...
            <div class="col-xs-12">
                ...
                <div class="form-group col-sm-6">
                    <label class="label label-green  half" style="width: 30% !important;">نوع المساعدة </label>
            ...
            <?php  if(isset($all_data) && !empty($all_data)){?>
                ...
                <table id="example" class=" display table table-bordered   responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tr class="info">
                        ...
                        <th class="text-center">إضافة رقم المحضر  </th>
                    ...
                    <?php foreach ($all_data as $record){ ?>
                        <tr class="">
                            ...
                            <td><button type="button" data-toggle="modal" data-target="#modal-sm-data-<?=$record->sarf_num?>" class="btn btn-xs btn-sm btn-success">إضافة</button>
                               </td>
                            <td>
                       ...
                       <div class="form-group col-sm-6 ">
                            <div class="form-group col-sm-12 pdd">
                                <div class="form-group col-sm-6 pdd">
                                    <label class="label label-green half">رقم الحضر </label>
...
<script>
    function get_data() {
        ...
        var  basicdataString = 'sarf_type=' + sarf_type + "&member_type="+member_type + "&mother_id="+mother_id + "&count_family="+count_family;
        if(sarf_type == 1 ) {
...
<script>
    function get_sarf_types() {
        ...
        if(sarf_type != 0 && member_type != 0  ) {
            ...
            $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>FamilyCashing',
                data:dataString,
                dataType: 'html',
                cache:false,
                success: function(html){
