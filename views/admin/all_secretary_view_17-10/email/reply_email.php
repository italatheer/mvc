                    ...
                    <div class="col-sm-8 padding-4">
                       ...
                       <div class="form-group col-sm-6 padding-4">
                         ...
                         <input type="text" class="form-control  testButton inputclass"
                                   name="motb3a_user_n" id="motb3a_user_n"  data-validation="required"
                                   readonly="readonly"
                                   onclick="$('#motb3aModal').modal('show'); "

                                   style="width: 88%;float: right;"
                                   value="<?= $message->email_motbaa_n; ?>">
                            <input type="hidden" name="motb3a_user_id" id="motb3a_user_id" value="<?= $message->email_motbaa_id; ?>">
                            <input type="hidden" name="tahwel_type" id="tahwel_type" value="">
                            <input type="hidden" name="tawel_id" id="tawel_id" value="">
                       ...
                       <div class="form-group col-sm-6 padding-4">
                         ...
                         <input type="text" class="form-control  testButton inputclass"
                                   name="etlaa_user_n" id="etlaa_user_n"
                                   readonly="readonly"
                                   onclick="$('#etlaaModal').modal('show'); "  data-validation="required"

                                   style="width: 88%;float: right;"

                                   value="<?= $message->email_etlaa_n; ?>">
                            <input type="hidden" name="etlaa_user_id" id="etlaa_user_id" value="<?= $message->email_etlaa_id; ?>">
                            <input type="hidden" name="tahwel_type" id="tahwel_type" value="">
                            <input type="hidden" name="tawel_id" id="tawel_id" value="">
...
<script>
 ...
 $('#to_user_n').append("<input type='hidden' id='id"+id+"'  name='to_user_fk[]' value='"+id+"'/><input type='hidden'  data-validation='required' id='n"+id+"' name='to_user_fk_name[]' value='"+name+"'/>");
    //$('#to_user_fk').val(id);
