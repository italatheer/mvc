    ...
    <div class="col-sm-8 " >
        <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12 ">
                    <div class="col_md_25 col-sm-6 padding-4">
                        ...
                        <div class="col-md-6 col-sm-6  no-padding">
                            ...
                            <input style="font-size: 16px!important; font-weight: 600 !important;" type="text"  data-validation="required" name="pill_num"
                                   value="<?=$pill_num?>"  onkeyup="$('#pill_num_span').html($(this).val())"
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="col_md_25 col-sm-6 padding-4">
                        ...
                        <div class="col-md-8 col-sm-6  no-padding">
                            ...
                            <input style="font-weight: 600 !important;" type="text" step="any" name="value" data-validation="required"
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="col_md_50 col-sm-6 padding-4">
                        ...
                        <div class="col-md-9 col-sm-6  no-padding">
                            ...
                            <input  style="width:87%; float: right;" type="text" name="person_name" id="person_name" class="form-control input_style_2"
                            ...
                            <input type="hidden" name="kafala_type" id="kafala_type" value="<?=$kafala_type?>">
                    ...
                    <div class="col_md_25 col-sm-6 padding-4">
                        ...
                        <div class="col-md-8 col-sm-6  no-padding">
                            <input type="text" step="any" name="person_mob" id="person_mob" data-validation="required"
                ...
                <div class="col-md-12 ">
                    <div class="col_md_25 col-sm-6 padding-4">
                        ...
                        <div class="col-md-8 col-sm-6  no-padding">
                            <select id="tahia" name="tahia" class="form-control input_style_2"
                                    onchange="GetGreetings(this.value)">    aria-required="true">
                                <option value=""> إختر </option>
                    ...
                    <div class="col_md_75 col-sm-6 padding-4">
                        ...
                        <div class="col-md-9 col-sm-6  no-padding">
                            ...
                            <select  class="form-control  input_style_2" id="erad_tbro3" name="erad_type"
                                     onchange="GEtF2a(this.value,'fe2a')"     data-validation="required" aria-required="true">
                                <option value=""> إختر  </option>
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="col_md_50 col-sm-6 padding-4">
                        ...
                        <div class="col-md-9 col-sm-6  no-padding">
                            ...
                            <select   class="form-control  input_style_2" id="fe2a" name="fe2a_type"
                                ...
                                <?php if(!empty($fe2a_type_arr)){  foreach ($fe2a_type_arr as $row){ ?>
                                    <option value="<?=$row->from_id?>"
                                        <?php if(!empty($fe2a_type)){ if($fe2a_type ==$row->from_id){
                                            echo'selected';
                                        }}?>
                    ...
                    <div class="col_md_50 col-sm-6 padding-4">
                        ...
                        <div class="col-md-9 col-sm-6  no-padding">
                            ...
                            <select id="band" name="bnd_type" class="form-control  input_style_2"
                                    data-validation="required" aria-required="true">
                                <option value="">إختر  </option>
                                <?php if(!empty($bnd_type_arr)){  foreach ($bnd_type_arr as $row){ ?>
                                    <option value="<?=$row->from_id?>"
                                        <?php if(!empty($bnd_type)){ if($bnd_type ==$row->from_id){
                                            echo'selected';
                                        }}?>
                    ...
                    <div class="col_md_100 col-sm-6 padding-4">
                        ...
                        <div class="col-md-9 col-sm-6  no-padding">
                            ...
                            <input type="text" step="any" name="about"
                                   class="form-control input_style_2 "
                                   data-validation-has-keyup-event="true"">
                ...
                <div class="col-md-12 "  <?php if($pay_method !=1){ ?>style="display: none" <?php } ?>id="cheq">
                    <fieldset class="cheq" <?php if($pay_method !=1){ ?>disabled="disabled"<?php } ?>>
                        <div class="col-sm-12">
                            <div class="col_md_25 col-sm-6 padding-4">
                                <div class="col-md-6 col-sm-6  no-padding ">
                ...
                <div class="col-md-12 " <?php if($pay_method !=3 ){ ?> style="display: none"  <?php } ?> id="shabka">
                    ...
                    <fieldset class="shabka"   <?php if($pay_method !=3 ){ ?> disabled="disabled" <?php } ?> >
                        <div class="col_md_30 col-sm-6 padding-4">
                            ...
                            <div class="col-md-8 col-sm-6  no-padding">
                                <select name="device_num" id="device_num" class="form-control  input_style_2 empty"
                        ...
                        <div class="col_md_35 col-sm-6 padding-4">
                            ...
                            <div class="col-md-7 col-sm-6  no-padding">
                                <input type="date"   name="process_date"  id="process_date" onchange="$('.shabka_date_span').html($(this).val())"
                                       onkeypress="validate_number(event)"    class="form-control  input_style_2 empty"
                ...
                <div class="col-md-12 " >
                        ...
                        <div class="col-md-3 col-sm-6  no-padding ">
                            <h6 class="label_title_2 ">الملف المرفق </h6>
                        </div>
                        <div class="col-md-4 col-sm-6  no-padding">
                            <input type="file" name="file" id="file"  class="form-control  input_style_2" data-validation="reuqired">
                        </div>
                ...
                <div class="col-md-12 no-padding">
                    ...
                    <div class="bond-body">
                        ...
                        <div class="col-xs-12 no-padding">
                            ...
                            <div class="col-xs-4">
                                <h6> الرقم :<span id="pill_num_span"> <?php if(!empty($result)){ echo$result->pill_num; } ?></span></h6>
                            </div>
                            <div class="col-xs-4">
                                <h6> التاريخ : <span id="day_date_span" style="float:left">
                                    </span></h6>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 no-padding">
                            <h6> استلمنا من :  <span id="title_span">
                                        <?php    if(!empty($result)){
                                        if(!empty($titles[$result->laqab])){ echo$titles[$result->laqab]->title_setting; } } ?>
                        ...
                        <div class="col-xs-12 no-padding" id="cheq_span"  <?php if($pay_method !=2){ ?>style="display: none" <?php } ?>>
                            ...
                            <div class="col-xs-4">
                                <h6> على بنــــك :<span class="cheq_bank_span"><?=$bank_id_fk?></span></h6>
                            </div>
                            <div class="col-xs-4">
                                <h6>بتـــاريخ : <span class="cheq_date_span" style="float:left"><?=$cheq_date?></span></h6>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 no-padding" id="shabka_span"  <?php if($pay_method !=3){ ?>style="display: none" <?php } ?>>
                            ...
                            <div class="col-xs-4">
                                <h6> إسم البنــــك :<span class="shabka_bank_span"><?=$bank_id_fk?></span></h6>
                            </div>
                            <div class="col-xs-4">
                                <h6>تاريخ العملية : <span class="shabka_date_span" style="float:left"><?=$process_date?></span></h6>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 no-padding" id="eda3_span"   <?php if($pay_method !=4 && $pay_method !=5  && $pay_method !=6){ ?> style="display: none" <?php } ?>>
                            ...
                            <div class="col-xs-4">
                                <h6> إسم البنــــك :<span class="eda3_bank_span"><?=$bank_id_fk?></span></h6>
                            </div>
                            <div class="col-xs-4">
                                <h6>تاريخ العملية : <span class="eda3_date_span" style="float:left"><?=$marg3_date?></span></h6>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 no-padding" id="mostadem_span"   <?php if($pay_method !=7){ ?>style="display: none" <?php } ?>>
                            <div class="col-xs-4 no-padding">
                                <h6> إسم البنــــك :<span class="mostadem_bank_span"><?=$bank_id_fk?></span></h6>
                            </div>
                            <div class="col-xs-4">
                                <h6>إسم الحساب البنكي : <span class="mostadem_account_span"><?=$bank_account_id_fk?></span></h6>
                            </div>
                            <div class="col-xs-4">
                                <h6> رقم الحساب البنكي :<span class="mostadem_num_span"><?=$bank_account_num?></span></h6>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 no-padding">
                            <table class="table table-bordered table_style">
                                <thead>
                                <tr>
                                    <th>تبرعات وهبات مقيدة نقدية</th>
                                    <th >تبرعات نقدية -كفالة</th>
                                    <th>تبرعات نقديو كفالة ايتام</th>
                                </tr>
                                </thead>
                                </tbody>
                            </table>
                        ...
                        <div class="col-xs-12 no-padding">
                            ...
                            <div class="col-md-4 col-xs-4">
                                <h6>المستلم</h6> <br />
                                <h6 style="color:darkred !important"> <?php echo $username; ?></h6>
                            </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-12 text-center" >
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab1" data-toggle="tab">إيصالات اليوم</a></li>
                                ...
                                <?php
                                    ...
                                    foreach($all_pills_today as $row){
                                        ...
                                        if($row->person_type == 1){
                                            if($row->kafala_type ==1){
                                                $name = $row->MemberDetails['k_name'];
                                            }elseif ($row->kafala_type ==2){
                                                $name = $row->MemberDetails['d_name'];
                                            }elseif ($row->kafala_type ==3){
...
<script>
    $(function() {
        ...
        $('#day_date_span').html(nowDate);
       // GetArabicNum(<?php /*echo $result->value;*/?>);
...
<script>
    ...
    function GetPayType(valu) {
        var selection = document.getElementById('pay_method');
        $('#pay_method_span').html(selection.options[valu].innerHTML);
        $('.empty').val(" ");
        var type =valu;
        switch(type) {
            case '2':
        ...
        if (valu !=0 &&   valu!='') {
            ...
            $.ajax({
                ...
                success: function(json_data){
                    ...
                    $('.arabic_number2').html(JSONObject['valu']);
