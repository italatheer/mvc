...
"	 data-validation="required" aria-required="true">
            ...
            <div class="col-md-12 ">
                ...
                <div class="col_md_25 col-sm-6 padding-4">
                    ...
                    <div class="col-md-8 col-sm-6  no-padding">
                        <select id="laqab"  name="laqab" class="form-control input_style_2 inputclass"
                ...
                <div class="col_md_25 col-sm-6 padding-4">
                    ...
                    <div class="col-md-8 col-sm-6  no-padding">
                        <input type="text" step="any" name="person_mob" id="person_mob" data-validation="required"
                              value="<?=$person_mob?>"  class="form-control  input_style_2 inputclass"
                               data-validation-has-keyup-event="true"">
            ...
            <div class="col-md-12 ">
                <div class="col_md_25 col-sm-6 padding-4">
                    ...
                    <div class="col-md-8 col-sm-6  no-padding">
                        <select id="tahia" name="tahia" class="form-control input_style_2 inputclass"
             ...
             <div class="col-md-12 ">
                    ...
                    <div class="col-md-9 col-sm-6  no-padding">
                        ...
                        <input type="text" name="about" data-validation="required"
                                class="form-control input_style_2 inputclass" onkeyup="$('.about_td').html($(this).val())"
...
<div class="col-sm-4 no-padding">
    <div  class=" panel panel-bd lobipanel-noaction  ">
       ...
       <table class="table table-bordered table_style" style="float:right;width: 87%;table-layout:fixed">
                            <thead>
                            <tr>
                                <th  style="width:50%;" id="band_tbro3_td"><?php if(!empty($result->band_title)){ echo$result->band_title; } ?></th>
                                <th style="width:50%;text-align: center;"
                                    <?php    if( !empty($result->bnd_type2 )){ ?>
                                        rowspan="2"
                                    <?php  } ?>
                                    class="about_td"><?php if(!empty($result->about)){ echo$result->about; } ?></th>
                                <th  style="width:20%;<?php echo$show_style;?>"    id="value1"><?php
                                    if(   !empty($result->bnd_type2 )){
                                        echo $result->value1;
                                    }
                                    ?></th>
                           ...
                           <tr id="secondFe2aType"   <?php    if( empty($result->bnd_type2 )){ ?> style="display: none" <?php  } ?>>
                               <th  style="width:50%;" id="band_tbro3_td2"><?php if(!empty($result->band_title2)){ echo$result->band_title2; } ?></th>
                               <th  style="width:50%;" id="value2"><?php if(!empty($result->value2)){ echo$result->value2; } ?></th>
                            </tr>
...
function searchResults() {
   ...
   var input_search_id = $('#input_search_id').val();
    ...
    if (array_search_id !='' &&   input_search_id!='') {
        var dataString = 'array_search_id=' + array_search_id+'&input_search_id='+ input_search_id;
        $.ajax({
            type:'post',
            url: '<?php echo base_url() ?>all_Finance_resource/all_pills/AllPills/getSearchResults',
            data:dataString,
            cache:false,
            success: function(data){


                $('#result_search_modal').html(data);

            }
        });

    }else{
        alert('الرجاء جميع الحقول')
    }
}
