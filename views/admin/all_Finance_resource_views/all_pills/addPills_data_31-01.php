...
"	 data-validation="required" aria-required="true">
      ...
      <button type="button"  id="myId" data-click-state=" <?php if( empty($result->fe2a_type2) &&  empty($result->bnd_type2 )){ echo 1; }else{ echo 0; } ?>"
              class="btn btn-success btn-next" style="float: right;"
 onclick="GetValues();"><i class="fa fa-plus"></i>  </button>
