...
<!--
    <table class="table table-ehsaiat">
            ...
            <tbody>
               <tr>
                 <td><img src="<?php echo base_url() ?>asisst/admin_asset/img/icons/st1.png" style="width: 45px;height: 45px;" />
                 <h6>أيتام</h6>
                 </td>
                
                 <td><?php echo $all_aytam['num'];?></td>
                 <td style="color: green;font-size: 20px !important;"><?php echo $all_aytam_shamla['num'] + $all_aytam_nos['num'];?></td>
                 <td style="color: green;font-size: 20px !important;"><?php echo $all_aytam['num']-( $all_aytam_shamla['num'] + $all_aytam_nos['num']);?></td>
               </tr>
               <tr>
                 <td><img src="<?php echo base_url() ?>asisst/admin_asset/img/icons/st2.png" style="width: 45px;height: 45px;" />
                    <h6>أرامل</h6>
                 </td>
               
                 <td><?php echo $all_armal['num'];?></td>
                 <td style="color: green;font-size: 20px !important;"><?php echo $all_armal_mkfol['num'];?></td>
                 <td style="color: green;font-size: 20px !important;"><?php echo $all_armal['num']-$all_armal_mkfol['num'];?></td>
               </tr>
               <tr>
                 <td><img src="<?php echo base_url() ?>asisst/admin_asset/img/icons/st4.png" style="width: 45px;height: 45px;" />
                 <h6>مستفيد بالغ</h6>
                 </td>
                
                 <td><?php echo $all_mostafed['num'];?></td>
                 <td style="color: green;font-size: 20px !important;"><?php echo $all_mostafed_mkfol['num'];?></td>
                 <td style="color: green;font-size: 20px !important;"><?php echo ($all_mostafed['num']-$all_mostafed_mkfol['num']);?></td>
               </tr>
        ...
        <div class="col-sm-4 no-padding">
             ...
             <div>
              ...
              <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#shakl-esal" aria-controls="shakl-esal" role="tab" data-toggle="tab">إيصال إستلام</a></li> 
                <li role="presentation"><a href="#nums-esalat" aria-controls="nums-esalat" role="tab" data-toggle="tab">إحصائيات</a></li>
              </ul>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="circle-ico">
                        ...
                        <div class="text-center" style="margin-top: -10px;">
                           <div style="font-size: 20px;" class=" counter" data-count="<?php echo round($all_money_today['total_nakdy'],2); ?>">0</div>        
                        </div>
                    </div>
