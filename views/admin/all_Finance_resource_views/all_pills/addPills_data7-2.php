                ...
                <div class="col_md_25 col-sm-6 padding-4">
                    ...
                    <div class="col-md-6 col-sm-6  no-padding">
                      ...
                      <?php /*}else{*/ echo'readonly'; /*} */ ?> name="pill_numS" id="pill_num"
                               value="<?php echo $pill_num;?>"  onkeyup="$('#pill_num_span').html($(this).val())"
            ...
            <div class="col-md-12 ">
                ...
                <div class="col_md_50 col-sm-6 padding-4">
                    ...
                    <div class="col-md-9 col-sm-6  no-padding">
                        <!--list="pepople_arr"-->
                        <input   autocomplete="off" style="width:87%; float: right;" type="text" name="person_name" id="person_name" class="form-control input_style_2 list inputclass"
    ...
    <div class="panel-body">
      ...
      <div class="col-md-8 col-xs-12" >
           ...
           ?>
            ...
            <div class=" counter" data-count="<?php echo $all_money_today['total_nakdy']; ?>">0</div> 
            <span>نقدي</span>
            
            
            </div>
            <div id="circle_counter"  style="background: #b31616;">
            <div class=" counter" data-count="<?php echo $all_money_today['total_chabka']; ?>">0</div> 
            <span>شبكة</span>
            
            
            </div>
            <div id="circle_counter"  style="background: #b77b09;">
            <div class=" counter" data-count="<?php echo $all_money_today['total_cheq']; ?>">0</div> 
            <span>شيك</span>
            ...
            <div class=" counter" data-count="<?php echo $all_money_today['total_eda3_nakdy']; ?>">0</div> 
            <span>إيداع نقدي</span>
            
            
            </div>
                  <div id="circle_counter" style="background: #79790d;">
            <div class=" counter" data-count="<?php echo $all_money_today['total_eda3_cheq']; ?>">0</div> 
            <span>إيداع شيك</span>
            ...
            <div class=" counter" data-count="<?php echo $all_money_today['total_tahwel']; ?>">0</div> 
            <span>تحويل</span>
      ...
      <div id="circle_counter" style="background: #6d2147;">
            <div class=" counter" data-count="<?php echo $all_money_today['total_amr_mostdem']; ?>">0</div> 
...
<td> <?php if(!empty($row->file)){ ?>
        ...
        -->
<td>
    <a type="button" class="" data-toggle="modal" style="cursor: pointer;"
            onclick="GetTable(<?php echo$row->id;?>)" data-target="#myModal"><i class="fa fa-eye"></i>
    </a>
</td>
<td>
                            ...
                            if(!empty($all_pills_inbox)){?>
                                ...
                                foreach($all_pills_inbox as $row){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <span title="<?php echo $row->publisher_name; ?>" style="font-size: 12px; color: white !important; font-weight: normal;"
                                         class="badge badge-add"><?php echo word_limiter($row->publisher_name,2);  ?></span>
                                        </td>
                                        <td><?=$row->qued_type?></td>
                                        <td><?=$row->qued_num?></td>
                                    </tr>
                ...
                <button type="button"  onclick="searchResults()" class="btn btn-success btn-next"/><i class="fa fa-search-plus"></i> بحث </button><br><br>
                    ...
                    <table   class="table example table-striped table-bordered" style="display: none;">
                        ...
                        <tr class="info">
                            ...
                            <th class="text-center" > اسم الايصال </th>
